...
function saveLayoutData(layout, saveTab, afterPanelSaved) {
    ...
    function savePanelData(panelData) {
        ...
        let savedPanel = Object.assign({ id, size, tabs, group, dropMode, activeId }, Utils_1.floatData(panelData));
        if (afterPanelSaved) {
    ...
    function saveBoxData(boxData) {
        ...
        return Object.assign({ id, size, mode, children }, Utils_1.floatData(boxData));
    }
    return {
