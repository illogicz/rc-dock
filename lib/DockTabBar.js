...
function DockTabBar(props) {
    ...
    return (React.createElement(FloatDrag_1.FloatHeader, { data: data, getRef: getRef, setDragging: setDragging, onUpdate: onUpdate, className: "dock-bar", role: "tablist", onKeyDown: onKeyDown },
