...
function dockPanelToPanel(layout, newPanel, panel, direction) {
    ...
    if (pos >= 0) {
        ...
        if (dockMode === box.mode) {
            ...
            let newChildBox = Object.assign({ mode: dockMode, children: afterPanel ? [panel, newPanel] : [newPanel, panel], size: panel.size }, Utils_1.floatData(panel));
    ...
    if (parentBox) {
        ...
        if (pos >= 0) {
            ...
            if (dockMode === parentBox.mode) {
                ...
                let newChildBox = Object.assign({ mode: dockMode, children: afterPanel ? [box, newPanel] : [newPanel, box], size: box.size }, Utils_1.floatData(box));
