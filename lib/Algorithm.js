...
exports.findNearestPanel = exports.getFloatPanelSize = exports.replacePanel = exports.fixLayoutData = exports.fixFloatPos = exports.maximize = exports.moveToFront = exports.removeFromLayout = exports.panelToWindow = exports.floatElement = exports.dockToBox = exports.dockToPanel = exports.converToPanel = exports.addTabToPanel = exports.addNextToTab = exports.find = exports.Filter = exports.nextZIndex = exports.nextId = exports.getUpdatedObject = void 0;
...
function dockToPanel(layout, newItem, panel, direction) {
    ...
    if (pos >= 0) {
        ...
        if (dockMode === box.mode) {
            ...
            let newChildBox = Object.assign({ mode: dockMode, children: afterPanel ? [panel, newItem] : [newItem, panel], size: panel.size }, Utils_1.floatData(panel));
...
exports.dockToPanel = dockToPanel;
function dockToBox(layout, newItem, box, direction) {
    ...
    if (parentBox) {
        ...
        if (pos >= 0) {
            ...
            if (dockMode === parentBox.mode) {
                ...
                let newChildBox = Object.assign({ mode: dockMode, children: afterPanel ? [box, newItem] : [newItem, box], size: box.size }, Utils_1.floatData(box));
...
exports.dockToBox = dockToBox;
function floatElement(layout, data, rect) {
...
function removeChild(layout, child) {
...
function moveToFront(layout, source) {
    if (source) {
        ...
        let changes = {};
        if (Utils_1.isPanel(source)) {
            data = source;
        }
        else if (Utils_1.isBox(source)) {
...
function fixFloatPos(layout, layoutWidth, layoutHeight) {
...
exports.fixFloatPos = fixFloatPos;
function fixLayoutData(layout, size, groups, loadTab) {
            ...
            if ('children' in child) {
                ...
                if (child.children.length === 0) {
                    ...
                    if (subChild.mode === box.mode) {
                        ...
                        Object.assign(subChild, Utils_1.floatData(child));
