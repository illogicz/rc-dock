...
class DockDropEdge extends React.PureComponent {
    constructor() {
        ...
        this.onDragOver = (e) => {
            ...
            if (move || !direction) {
                ...
                let panelSize = DragManager_1.DragState.getData('panelSize', this.context.getDockId());
    ...
    getDirectionInternal(e, group, samePanel, single) {
        ...
        else if (Utils_1.isBox(this.props.dropFrom)) {
    ...
    getDirection(e) {
        ...
        const box = DragManager_1.DragState.getData('box', dockId);
        ...
        const group = Utils_1.isPanel(from) ? this.context.getGroup(from.group) : undefined;
