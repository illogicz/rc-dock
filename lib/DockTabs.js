...
class DockTabs extends React.PureComponent {
    constructor() {
        ...
        this.renderTabBar = (navListProps, TabNavList) => {
            ...
            let showNewWindowButton = group.newWindow && WindowBox_1.WindowBox.enabled && isFloating;
            ...
            return (_d = renderTabBar === null || renderTabBar === void 0 ? void 0 : renderTabBar(props, DockTabBar_1.DockTabBar)) !== null && _d !== void 0 ? _d : React.createElement(DockTabBar_1.DockTabBar, Object.assign({}, props));
            // return (
            //   <DockTabBar
