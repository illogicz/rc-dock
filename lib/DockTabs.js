...
class DockTabs extends React.PureComponent {
    constructor() {
        ...
        this.renderTabBar = (props, TabNavList) => {
            ...
            return (_a = renderTabBar === null || renderTabBar === void 0 ? void 0 : renderTabBar(barProps, DockTabBar_1.DockTabBar)) !== null && _a !== void 0 ? _a : React.createElement(DockTabBar_1.DockTabBar, Object.assign({}, barProps));
            // return (
